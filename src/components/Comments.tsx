...
const Comments = ({ post, getPost }: Props) => {
  ...
  const handelDeleteComment = async (data: CommentsInterface) => {
            ...
            <div className="comment__box" key={comment.createdAt}>
              <div className="comment__profile-box">
                ...
                {comment.uid == user?.uid && (
                  <div className="comment__delete" onClick={() => handelDeleteComment(comment)}>
                    삭제
                  </div>
                )}
              </div>
